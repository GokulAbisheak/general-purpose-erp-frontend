                        ...
                        <div className='justify-center items-center w-full px-[50px]'>
                            ...
                            <form>
                                <div className='grid gap-[10px]'>
                                    <input type='text' placeholder='Business Name' className='px-[10px] h-[40px] border-[2px] border-purple-700 rounded w-full outline-0'></input>
                                    ...
                                    <input type='text' placeholder='Confirm Password' className='px-[10px] h-[40px] border-[2px] border-purple-700 rounded w-full outline-0'></input>
                                    <button type='submit' className='bg-purple-700 h-[40px] text-white mt-[10px] mb-[10px] rounded uppercase text-sm font-semibold w-full hover:bg-purple-900'>Signup</button>
                                </div>
                            </form>
                            <div className='grid'>
                                <Link to='/login' className='text-purple-700 text-sm hover:text-purple-900'>Already have an account?</Link>
                            </div>
                        </div>
                    </div>
                </div>
