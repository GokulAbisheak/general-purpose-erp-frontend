...
const SideNav = (isMobileOpen) => {
  ...
  return (
    <>
      <div className={`min-w-[200px] h-screen overflow-scroll bg-gradient-to-t from-purple-700 to-purple-900 absolute bg-opacity-[50%] md:bg-opacity-[100%] md:sticky top-0 left-0 ${isMobileOpen.state ? 'block' : 'hidden'} md:block`}>
